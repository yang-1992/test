...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	@Autowired
	private UsernamePasswordJwtCookieFilter usernamePasswordJwtCookieFilter;
	...
	public AuthenticationManager authenticationManager() {
		...
		AuthenticationManager authenticationManager=new ProviderManager(Arrays.asList(daoAuthenticationProvider));
	...
	public void configure(WebSecurity web) throws Exception {
		web.ignoring()
			...
			.antMatchers("/api/to/station/page/*")
			.antMatchers("/api/sm/allUserStationRel")
			.antMatchers("/*/*")
			// TODO 上测试之前关闭
			.antMatchers("/**")
		;
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.addFilterBefore(corsFilter, UsernamePasswordAuthenticationFilter.class)
		   ...
		   .addFilterAfter(usernamePasswordJwtCookieFilter,UsernamePasswordAuthenticationFilter.class)
